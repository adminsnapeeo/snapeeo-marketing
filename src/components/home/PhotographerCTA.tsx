    ...
    <section id="for-photographers" className="section-base-tight-compact scroll-mt-24">
      <div className="mx-auto max-w-content px-4 md:px-8 lg:px-12">
        <SectionHeading
          ...
          subtitle="Snapeeo is a marketplace, not a studio. We're onboarding Jaipur photographers before launch — get early access, set your rates, and be first in line for bookings."
        />
        ...
        <div className="mt-10 flex flex-col items-center gap-4 text-center">
          <p className="max-w-xl text-sm text-white/80 md:text-base">
            ...
            Just a platform designed to bring you more clients in Jaipur.
          </p>
          <Button
            size="lg"
            variant="white"
